...
opponent_idle_image = pygame.image.load("Mothman.png")
opponent_attack_image = pygame.image.load("Mothman_attack1.png")
opponent_alt_attack_image = pygame.image.load("Mothman_attack2.png")
opponent_block_image = pygame.image.load("Mothman_block.png")
