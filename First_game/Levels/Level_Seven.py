...
# Load images
background_image = pygame.image.load("cavebackground.jpg")
background_image = pygame.transform.scale(background_image, (WIDTH, HEIGHT))

player_idle_image = pygame.image.load("protag_side.png")
player_attack_image = pygame.image.load("Hero_attack_1.png")
player_alt_attack_image = pygame.image.load("Hero_attack_2.png")
player_block_image = pygame.image.load("Hero_block.png")

opponent_idle_image = pygame.image.load("Michevious_Orange.png")
opponent_attack_image = pygame.image.load("Orange_attack1.png")
opponent_alt_attack_image = pygame.image.load("Orange_attack2.png")
opponent_block_image = pygame.image.load("Orange_block.png")
